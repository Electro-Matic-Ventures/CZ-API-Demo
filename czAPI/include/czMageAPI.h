...
#define LDU_SYNCBRIMODE_END				0x01
#define LDU_SYNCBRIMODE_START			0x02
...
CZAPI_DECLARE(INT32U) czDirectTilePHYWriteCoefficent1(INT8U port,INT16U tileAddr);
CZAPI_DECLARE(INT32U) czDirectTilePHYWriteCoefficent2(INT8U *filePath, INT8U port,INT16U tileAddr, INT8U modeAddr, INT8U* data = NULL, INT32U dataLen = 0);

CZAPI_DECLARE(INT32U) czWriteCmdBuf(INT8U* buf, INT32U len);
