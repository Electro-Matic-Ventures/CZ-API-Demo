...
CZAPI_DECLARE(INT32U) czCorePlayProgram(INT8U* prjPath, INT8U *listName, INT8U* prgName, INT8U continueFlag);
CZAPI_DECLARE(INT32U) czCorePlayEmergencyProgram(INT8U* prjPath, INT8U *listName, INT8U* prgName);
CZAPI_DECLARE(INT32U) czCoreStopEmergencyProgram();
