...
//****************************************************************************************************************
//**** 函数名:czShowMsgTimeout
//**** 功  能:控制显示屏显示信息,如果发送F盘成功,就把内容存放到F盘,否则就存放到D盘,开放重试次数和超时时间
//**** 参  数:
//****        msg             - 显示信息
//****        msg_size        - 信息大小
//****        font            - 字体,参考font define
...
//****        other           - 失败
//****************************************************************************************************************
CZAPI_DECLARE(INT32U) czShowMsgTimeout(char* msg, INT32U msg_size, INT32U font,INT32U color,INT32U mode, 
									   INT32U stay_time_sec, char* sign_ip,INT32U sign_port,INT32U is_store_ram=0,
							 		   INT32U is_send_playlist=1,
									   INT8U retryTimes=3, INT32U timeoutms=3000,
									   conn_type type=COMM_UDP,char* comStr="COM3",INT32U baudrate=9600,INT16U dstAddr=0x0101);
#ifdef __cplusplus
}
#endif
