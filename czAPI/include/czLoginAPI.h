...
CZAPI_DECLARE(INT32U) czGetSoftwareLock(INT8U *lockFlag, INT32U *lockRemainTimes, INT32U *deviceIP);
CZAPI_DECLARE(INT32U) czSetSoftwareLock(INT8U lockFlag, INT32U lockTimeOut, INT32U deviceIP);
